        ...
        <div class="contents">
            ...
            <div class="container-fluid">
                        ...
                        <div class="breadcrumb-main user-member justify-content-sm-between ">
                            <div class=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                                <div class="d-flex align-items-center user-member__title justify-content-center mr-sm-25">
                                    <h4 class="text-capitalize fw-500 breadcrumb-title">Corbeille membre</h4>

                                    <?php
                            $query2 = "select count(*) as count from utilisateurs where isDeleted=1";
                            ...
                            ?>
                                    <span class="sub-title ml-sm-25 pl-sm-25"><?php echo $row['count'] ?> Membre(s) supprimé</span>
                                </div>
                ...
                <div class="row">
                    ...
                    $query = "SELECT * FROM utilisateurs where isDeleted=1 ";
                                    ...
                                    <div class="card-body text-center pt-30 px-25 pb-5">
                                        ...
                                        <div class="account-profile-cards  ">
                                            <div class="ap-img d-flex justify-content-center">
                                                ...
                                                <img class="ap-img__main bg-opacity-primary  wh-120 rounded-circle mb-3 " src="<?= $row['image']?>" alt="profile">
                                            </div>
                                            <div class="ap-nameAddress">
                                                <h6 class="ap-nameAddress__title"><?= $row['nom'] . ' ' . $row['prenom'] ?></h6>
                                                <p class="ap-nameAddress__subTitle  fs-14 pt-1 m-0 "><?= $row['profession'] ?></p>
                                            </div>
                                            <div class="ap-button account-profile-cards__button button-group d-flex justify-content-center flex-wrap pt-20">
                                                <a href="recuperer.php?rid=<?= $row['id']?>" onclick="return confirm('voulez-vous vraiment récupérer cet utilisateur')" class="btn btn-primary">Récupérer</a>
                                                &nbsp;
