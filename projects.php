                        ...
                        <div class="breadcrumb-main user-member justify-content-sm-between createModal">
                            <div class=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                                <div class="d-flex align-items-center user-member__title justify-content-center mr-sm-25">
                                    ...
                                    <?php
                                    $nbr_projet = "SELECT COUNT(*) as count FROM `projets` WHERE progress<100 and    isDeleted=0";
            ...
            <div class="projects-tab-content projects-tab-content--progress">
                <div class="tab-content mt-25" id="ap-tabContent">
                    <div class="tab-pane fade show active" id="ap-overview" role="tabpanel" aria-labelledby="ap-overview-tab">
                        ...
                        <div class="row">
                            <?php
                            $query_ptojet = "select * from projets where isDeleted=0";
                                                ...
                                                <div class="progress-wrap d-flex align-items-center mb-0">
                                                    <div class="progress">
                                                        <?php if ($projet['progress'] < 100) { ?>
                                                            <div class="progress-bar bg-primary" role="progressbar" style="width: <?= $moy['moyenne'] ?>%;" aria-valuenow="<?= $projet['progress'] ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                                        <?php } else { ?>
                                                            <div class="progress-bar bg-success" role="progressbar" style="width: <?= $moy['moyenne'] ?>%;" aria-valuenow="<?= $projet['progress'] ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                                        <?php
                                                    ...
                                                    <span class="progress-percentage"><?= $moy['moyenne'] ?>%</span>
