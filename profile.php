...
if (isset($_POST['modifier'])) {
    ...
    $query_add = "UPDATE utilisateurs set nom = '$nom',prenom='$prenom',date_naissance='$date_de_naissance',telephone='$telephone',email='$email', role='$role',profession='$profession' where id='{$_SESSION['id']}' ";
...
if (isset($_POST['modifierMotPasse'])) {
    ...
    $update_password = "UPDATE utilisateurs set password='$motdepaase' where id='{$_SESSION['id']}'";
